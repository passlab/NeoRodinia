/*
 * Level 1: Basic Taskloop
 * This level uses #pragma omp taskloop to create tasks for iterations. The iterations are divided into tasks automatically by the runtime.
 *
 */
#include "sc.h"
// #include "sc_kernel.h"
